...
<template>
  ...
  <Transition>
    <div class="message message-opaque" v-if="showHelp">
      ...
      <p class="help-text">Guess the Insight book subject in 6 guesses.</p>
      <ul class="help-text">
        <li style="margin-bottom: 1rem;">Each guess must be a valid 5-letter <strong>dictionary word</strong> or <strong>Insight book subject.</strong></li>
